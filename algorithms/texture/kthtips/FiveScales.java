...
/*  36:    */         
/*  37:265 */         pwTr.println(data[i][18]);
/*  38:266 */         pwTr.println(data[i][22]);
/*  39:267 */         pwTr.println(data[i][26]);
/*  40:    */         
/*  41:269 */         pwTr.println(data[i][36]);
/*  42:270 */         pwTr.println(data[i][40]);
/*  43:271 */         pwTr.println(data[i][44]);
/*  44:    */         
/*  45:273 */         pwTr.println(data[i][54]);
/*  46:274 */         pwTr.println(data[i][58]);
/*  47:275 */         pwTr.println(data[i][62]);
/*  48:    */         
/*  49:277 */         pwTr.println(data[i][72]);
/*  50:278 */         pwTr.println(data[i][76]);
/*  51:279 */         pwTr.println(data[i][80]);
/*  52:    */       }
/*  53:283 */       for (int i = 0; i < 10; i++) {
/*  54:284 */         for (int j = 0; j < 81; j++) {
/*  55:285 */           if (((j < 0) || (j > 8)) && 
/*  56:286 */             ((j < 18) || (j > 26)) && 
/*  57:287 */             ((j < 36) || (j > 44)) && 
/*  58:288 */             ((j < 54) || (j > 62)) && (
/*  59:289 */             (j < 72) || (j > 80))) {
/*  60:290 */             pwTs.println(data[i][j]);
/*  61:    */           }
/*  62:    */         }
/*  63:    */       }
/*  64:294 */       br.close();
 ...
 * Qualified Name:     vpt.algorithms.texture.kthtips.FiveScales
