...
/* 10:   */   {
/* 11:43 */     for (int i = 1; i <= 200; i++)
/* 12:   */     {
/* 13:44 */       String trainPath = "train" + i + ".arff";
/* 14:45 */       String testPath = "test" + i + ".arff";
/* 15:   */       
/* 16:47 */       String[] options = { "-t", trainPath, "-T", testPath, "-o", "-K", "3", "-W", "0", "-A", "weka.core.neighboursearch.LinearNNSearch -A \"weka.core.ManhattanDistance -R first-last\"" };
/* 17:   */       try
/* 18:   */       {
/* 19:50 */         String results = Evaluation.evaluateModel(new IBk(), options);
 ...
 * Qualified Name:     vpt.algorithms.texture.kthtips2a.ClassifierTest2
