...
/* 35:36 */       s1 += (p - mean) * (p - mean) * (p - mean) * (p - mean);
/* 36:37 */       s2 += (p - mean) * (p - mean);
/* 37:   */     }
/* 38:40 */     s1 /= size;
/* 39:41 */     s2 /= size;
/* 40:   */     
/* 41:43 */     this.output = Double.valueOf(s1 / Math.pow(s2, 2.0D));
/* 42:   */   }
/* 43:   */   
...
/* 46:   */     try
/* 47:   */     {
/* 48:49 */       return (Double)new Kurtosis().preprocess(new Object[] { img });
/* 49:   */     }
 ...
 * Qualified Name:     vpt.algorithms.statistical.Kurtosis
