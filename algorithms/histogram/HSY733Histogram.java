...
/*  6:   */ import vpt.Image;
/*  7:   */ 
/*  8:   */ public class HSY733Histogram
/*  9:   */   extends Algorithm
/* 10:   */ {
...
/* 29:   */     }
/* 30:27 */     this.output = new double[63];
...
/* 38:   */         
/* 39:36 */         this.output[(hue * 9 + sat * 3 + lum)] += 1.0D;
/* 40:   */       }
/* 41:   */     }
...
/* 53:   */     try
/* 54:   */     {
/* 55:52 */       return (double[])new HSY733Histogram().preprocess(new Object[] { image, normalized });
/* 56:   */     }
 ...
 * Qualified Name:     vpt.algorithms.histogram.HSY733Histogram
