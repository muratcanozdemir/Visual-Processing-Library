...
/* 25:   */   {
/* 26:22 */     this.output = MErosion.invoke(this.input, this.se, this.or);
/* 27:23 */     this.output = MDilation.invoke(this.output, this.se, this.or);
/* 28:   */   }
/* 29:   */   
...
/* 32:   */     try
/* 33:   */     {
/* 34:29 */       return (Image)new MOpening().preprocess(new Object[] { image, se, or });
/* 35:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.multi.MOpening
