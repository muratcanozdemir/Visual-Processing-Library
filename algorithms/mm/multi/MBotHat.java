...
/* 26:   */   {
/* 27:23 */     this.output = AbsSubtraction.invoke(MClosing.invoke(this.input, this.se, this.or), this.input);
/* 28:   */   }
/* 29:   */   
...
/* 32:   */     try
/* 33:   */     {
/* 34:29 */       return (Image)new MBotHat().preprocess(new Object[] { image, se, or });
/* 35:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.multi.MBotHat
