...
/* 39:43 */           this.output.setVXYDouble(x, y, getMin(this.input, x, y, this.se.getCoords()));
/* 40:   */         }
/* 41:   */       }
/* 42:   */     }
/* 43:   */     else
...
/* 52:54 */           tmp.setVXYDouble(x, y, getMin(this.input, x, y, hline.getCoords()));
/* 53:   */         }
/* 54:   */       }
/* 55:56 */       this.pixelArray = new double[vline.getCoords().length][];
/* 56:58 */       for (int x = 0; x < this.xdim; x++) {
/* 57:59 */         for (int y = 0; y < this.ydim; y++) {
/* 58:60 */           this.output.setVXYDouble(x, y, getMin(tmp, x, y, vline.getCoords()));
/* 59:   */         }
/* 60:   */       }
/* 61:   */     }
/* 62:   */   }
/* 63:   */   
/* 64:   */   private double[] getMin(Image img, int x, int y, Point[] coords)
/* 65:   */   {
/* 66:66 */     int index = 0;
/* 67:68 */     for (int i = 0; i < coords.length; i++)
/* 68:   */     {
/* 69:70 */       int _x = x + coords[i].x;
/* 70:71 */       int _y = y + coords[i].y;
/* 71:73 */       if (_x < 0) {
/* 72:73 */         _x = 0;
/* 73:   */       }
/* 74:74 */       if (_y < 0) {
/* 75:74 */         _y = 0;
/* 76:   */       }
/* 77:75 */       if (_x >= this.xdim) {
/* 78:75 */         _x = this.xdim - 1;
/* 79:   */       }
/* 80:76 */       if (_y >= this.ydim) {
/* 81:76 */         _y = this.ydim - 1;
/* 82:   */       }
/* 83:78 */       this.pixelArray[(index++)] = img.getVXYDouble(_x, _y);
/* 84:   */     }
/* 85:82 */     return index > 0 ? this.or.min(this.pixelArray) : img.getVXYDouble(x, y);
/* 86:   */   }
/* 87:   */   
...
/* 90:   */     try
/* 91:   */     {
/* 92:88 */       return (Image)new MErosion().preprocess(new Object[] { image, se, or });
/* 93:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.multi.MErosion
