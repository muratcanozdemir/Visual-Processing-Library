...
/*  8:   */ 
/*  9:   */ public class GInternGradient
...
/* 24:   */   {
/* 25:21 */     this.output = AbsSubtraction.invoke(this.input, GErosion.invoke(this.input, this.se));
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new GInternGradient().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.GInternGradient
