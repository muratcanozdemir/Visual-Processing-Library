...
/* 24:   */   {
/* 25:21 */     this.output = AbsSubtraction.invoke(this.input, GOpening.invoke(this.input, this.se));
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:26 */       return (Image)new GTopHat().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.GTopHat
