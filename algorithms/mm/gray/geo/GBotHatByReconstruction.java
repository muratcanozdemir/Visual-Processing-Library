...
/*  8:   */ 
/*  9:   */ public class GBotHatByReconstruction
...
/* 15:   */   
/* 16:   */   public GBotHatByReconstruction()
/* 17:   */   {
...
/* 24:   */   {
/* 25:21 */     this.output = AbsSubtraction.invoke(GClosingByReconstruction.invoke(this.input, this.se), this.input);
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new GBotHatByReconstruction().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.geo.GBotHatByReconstruction
