...
/*  9:   */ 
/* 10:   */ public class GGeodesicErosion
...
/* 26:   */   {
/* 27:23 */     this.output = Maximum.invoke(GErosion.invoke(this.inputImage, this.se), this.mask);
/* 28:   */   }
/* 29:   */   
...
/* 32:   */     try
/* 33:   */     {
/* 34:29 */       return (Image)new GGeodesicErosion().preprocess(new Object[] { image, se, mask });
/* 35:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.geo.GGeodesicErosion
