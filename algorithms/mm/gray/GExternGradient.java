...
/*  8:   */ 
/*  9:   */ public class GExternGradient
...
/* 24:   */   {
/* 25:21 */     this.output = AbsSubtraction.invoke(GDilation.invoke(this.input, this.se), this.input);
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new GExternGradient().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.GExternGradient
