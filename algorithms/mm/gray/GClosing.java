...
/* 23:   */   {
/* 24:20 */     this.output = GDilation.invoke(this.input, this.se);
/* 25:21 */     this.output = GErosion.invoke(this.output, this.se);
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new GClosing().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.GClosing
