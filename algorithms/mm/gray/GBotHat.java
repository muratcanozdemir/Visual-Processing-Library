...
/* 24:   */   {
/* 25:21 */     this.output = AbsSubtraction.invoke(GClosing.invoke(this.input, this.se), this.input);
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new GBotHat().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.GBotHat
