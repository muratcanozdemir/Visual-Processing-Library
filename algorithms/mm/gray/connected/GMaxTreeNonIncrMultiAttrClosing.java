...
/*  8:   */ 
/*  9:   */ public class GMaxTreeNonIncrMultiAttrClosing
...
/* 16:   */   
/* 17:   */   public GMaxTreeNonIncrMultiAttrClosing()
/* 18:   */   {
...
/* 25:   */   {
/* 26:32 */     this.output = Inversion.invoke(GMaxTreeNonIncrMultiAttrOpening.invoke(Inversion.invoke(this.input), this.channel, this.crit));
/* 27:   */   }
/* 28:   */   
...
/* 31:   */     try
/* 32:   */     {
/* 33:37 */       return (Image)new GMaxTreeNonIncrMultiAttrClosing().preprocess(new Object[] { input, channel, c });
/* 34:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.connected.GMaxTreeNonIncrMultiAttrClosing
