...
/* 23:   */   {
/* 24:20 */     this.output = AErosion.invoke(this.input, this.se);
/* 25:21 */     this.output = ADilation.invoke(this.output, this.se);
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new AOpening().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.gray.adaptive.AOpening
