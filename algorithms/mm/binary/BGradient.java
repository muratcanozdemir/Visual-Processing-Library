...
/* 24:   */   {
/* 25:21 */     this.output = AbsSubtraction.invoke(BDilation.invoke(this.input, this.se), BErosion.invoke(this.input, this.se));
/* 26:   */   }
/* 27:   */   
...
/* 30:   */     try
/* 31:   */     {
/* 32:27 */       return (Image)new BGradient().preprocess(new Object[] { image, se });
/* 33:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.binary.BGradient
