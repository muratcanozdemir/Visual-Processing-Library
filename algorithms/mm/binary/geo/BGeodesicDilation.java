...
/*  7:   */ import vpt.algorithms.mm.binary.BDilation;
/*  8:   */ import vpt.util.se.FlatSE;
/*  9:   */ 
/* 10:   */ public class BGeodesicDilation
...
/* 26:   */   {
/* 27:23 */     this.output = Minimum.invoke(BDilation.invoke(this.input, this.se), this.mask);
/* 28:   */   }
/* 29:   */   
...
/* 32:   */     try
/* 33:   */     {
/* 34:29 */       return (Image)new BGeodesicDilation().preprocess(new Object[] { image, se, mask });
/* 35:   */     }
 ...
 * Qualified Name:     vpt.algorithms.mm.binary.geo.BGeodesicDilation
